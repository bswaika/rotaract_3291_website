...
class AdminEventController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('functionalities.events.listevents', ['events'=>$events]);
    }
    ...
    {
        //
        return view('functionalities.events.createevent');
    }
    ...
    public function edit($id)
    {
        ...
        return view('functionalities.events.editevent', ["event"=>$event, "start"=>$start, "end"=>$end, "open"=>$open, "close"=>$close]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/admin/events')->with('update_success', 'Event Updated');
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/events')->with('delete_success', 'Event Deleted');
    }
