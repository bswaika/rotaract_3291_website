...
@section('content')
    <div class="container">
        ...
        <hr class="purple-hr">
        <form class="form-horizontal" method="POST" action="{{url('/admin/events')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control ckeditor" rows="5" id="description" name="description" placeholder="Write a few lines about the Event" style="resize:none;" required></textarea>
                </div>
            </div>
            <div class="form-group">
