...
@section('content')
    <div class="container">
        ...
        <a href="/admin/events" class="btn btn-primary">Go Back</a>
        <hr class="purple-hr">
        <form class="form-horizontal" method="POST" action="{{url('/admin/events/'.$event->id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control ckeditor" rows="5" id="description" name="description" placeholder="Write a few lines about the Event" style="resize:none;" required>{!!$event->description!!}</textarea>
                </div>
            </div>
            <div class="form-group">
