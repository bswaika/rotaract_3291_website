...
@section('content')
    <div class="container">
        ...
        <a href="/club/event/blogs" class="btn btn-primary">Go Back</a>
        <hr class="purple-hr">
        <form class="form-horizontal" method="POST" action="{{url('/club/event/blogs/'.$event_blog->id)}}">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
