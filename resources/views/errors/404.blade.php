...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/static/404.css">
...
<body>
    ...
    <header class="error home-hero">
        <img src="/storage/site_assets/cover/cover-error.jpeg" alt="Stock Photo of Friendship" class="home-hero-img">
        <div class="home-hero-overlay"></div>
        <h1 class="home-hero-title rbt">-&nbsp;-&nbsp;<span class="cmfrt">404</span>&nbsp;-&nbsp;-<br>page not found</h1>
        <div class="container">
